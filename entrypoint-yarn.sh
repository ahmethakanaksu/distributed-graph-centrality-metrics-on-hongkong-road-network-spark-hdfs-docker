...
then
  ...
  hdfs dfs -mkdir -p /data/Hongkong
  echo "Created Hongkong dir"


  # copy the data to the data HDFS directory
  hdfs dfs -put -f ./Hongkong.co /data/Hongkong/Hongkong.co
  hdfs dfs -put -f ./Hongkong.road-d /data/Hongkong/Hongkong.road-d
  hdfs dfs -put -f ./Hongkong.road-t /data/Hongkong/Hongkong.road-t
